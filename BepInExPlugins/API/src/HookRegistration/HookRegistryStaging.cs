...
internal class HookRegistryStaging
{
    ...
    internal void RegisterHook_System_OnUpdate_Prefix(Hooks.System_OnUpdate_Prefix.HookFunction hook, Il2CppSystem.Type systemType, Hooks.System_OnUpdate_Prefix.Options options)
    {
    ...
    internal void RegisterHook_System_OnUpdate_Postfix(Hooks.System_OnUpdate_Postfix.HookFunction hook, Il2CppSystem.Type systemType, Hooks.System_OnUpdate_Postfix.Options options)
    {
