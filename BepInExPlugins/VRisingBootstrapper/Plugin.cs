...
public class VRisingBootstrapperPlugin : BasePlugin
{
    ...
    // ///
    // /// .vrisingbootstrapper-example "some quoted string" 1 1.5
    // /// .vrisingbootstrapper-example boop 21232
    // /// .vrisingbootstrapper-example boop-boop
    // ///</remarks>
    // [Command("vrisingbootstrapper-example", description: "Example command from vrisingbootstrapper", adminOnly: true)]
